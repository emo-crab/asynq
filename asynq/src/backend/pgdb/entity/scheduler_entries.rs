...
#[sea_orm(table_name = "asynq_scheduler_entries")]
pub struct Model {
...
pub enum Relation {
  ...
  Scheduler,
  #[sea_orm(has_many = "super::scheduler_events::Entity")]
  SchedulerEvents,
}

impl Related<super::schedulers::Entity> for Entity {
  fn to() -> RelationDef {
    Relation::Scheduler.def()
  }
}

impl Related<super::scheduler_events::Entity> for Entity {
  fn to() -> RelationDef {
    Relation::SchedulerEvents.def()
  }
}
