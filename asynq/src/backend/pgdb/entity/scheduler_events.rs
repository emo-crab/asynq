...
pub enum Relation {
  // task_id currently stores scheduler entry id in the scheduler event recording path.
  #[sea_orm(
    belongs_to = "super::scheduler_entries::Entity",
    from = "Column::TaskId",
    to = "super::scheduler_entries::Column::Id"
  )]
  SchedulerEntry,
}
